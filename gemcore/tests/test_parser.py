...
from gemcore.parser import (
    CSVParser, BNABankParser, ScoBankParser, WFGBankParser)
from gemcore.tests.helpers import BaseTestCase


class OldParseBaseTestCase(BaseTestCase):
...
class OldParseBNATestCase(OldParseBaseTestCase):

    def test_real_file(self):
        result, rows, account = self.do_parse(BNABankParser(), 'bank1.csv')
...
class OldParseScoTestCase(OldParseBaseTestCase):

    def test_real_file(self):
        result, rows, account = self.do_parse(ScoBankParser(), 'bank2.csv')
...
class OldParseWFGTestCase(OldParseBaseTestCase):

    def test_real_file(self):
        result, rows, account = self.do_parse(WFGBankParser(), 'bank4.csv')
