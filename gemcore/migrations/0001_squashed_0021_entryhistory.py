# -*- coding: utf-8 -*-
# Generated by Django 1.10.7 on 2017-06-15 23:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', bitfield.models.BitField([('bureaucracy', 'bureaucracy'), ('car', 'car'), ('change', 'change'), ('food', 'food'), ('fun', 'fun'), ('health', 'health'), ('house', 'house'), ('maintainance', 'maintainance'), ('other', 'other'), ('rent', 'rent'), ('taxes', 'taxes'), ('travel (transport)', 'travel (transport)'), ('utilities', 'utilities'), ('work(ish)', 'work(ish)'), ('imported', 'imported'), ('trips', 'trips')], default=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.CharField(choices=[('bureaucracy', 'bureaucracy'), ('car', 'car'), ('change', 'change'), ('food', 'food'), ('fun', 'fun'), ('health', 'health'), ('house', 'house'), ('maintainance', 'maintainance'), ('other', 'other'), ('rent', 'rent'), ('taxes', 'taxes'), ('travel (transport)', 'travel (transport)'), ('utilities', 'utilities'), ('work(ish)', 'work(ish)'), ('imported', 'imported'), ('trips', 'trips')], max_length=256)),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gemcore.Account')),
